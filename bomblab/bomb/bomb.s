...
0000000000400da0 <main>:
  ...
  400e19:	e8 84 05 00 00       	callq  4013a2 <initialize_bomb> #初始化对stdin的读入
...
000000000040131b <string_length>:
  ...
  401327:	89 d0                	mov    %edx,%eax //为啥要从rdx变换为edx，因为返回值是32位的int，高32位的地址被自动忽略
  401329:	29 f8                	sub    %edi,%eax //持续计算字符串长度
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx) 
  40132e:	75 f3                	jne    401323 <string_length+0x8>
  401330:	f3 c3                	repz retq 
  401332:	b8 00 00 00 00       	mov    $0x0,%eax #string_length+0x17
  401337:	c3                   	retq   
...
0000000000401338 <strings_not_equal>:
  ...
  40139b:	89 d0                	mov    %edx,%eax #strings_not_equal+0x63
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
00000000004013f9 <skip>:
  ...
  401435:	48 89 d8             	mov    %rbx,%rax #skip+0x3c
  401438:	5b                   	pop    %rbx
  401439:	c3                   	retq   
...
000000000040149e <read_line>:
  ...
  4014a2:	b8 00 00 00 00       	mov    $0x0,%eax #清空eax,四字节
  ...
  401530:	48 81 c6 80 37 60 00 	add    $0x603780,%rsi #read_line+0x81
